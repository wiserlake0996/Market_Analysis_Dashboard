...
def app():
    ...
    cols[0].radio('Data source', ['Alpaca', 'Polygon', 'Yahoo'])
    cols[1].multiselect('Data type((s)', ['Trades', 'Quotes', 'Bars'])
    cols[2].multiselect('options', ['split-adj', 'dividend'])
    cols[3].selectbox('interval (bars only)', ['1m','5m', '10m', '30m', '1h', '1d'])
